function generateDataScience(data) {
    return `
      <!DOCTYPE html>
<html lang="en">
...
<body>
          ...
          <nav id="navmenu" class="navmenu">
            <ul>
              ...
              <li class="listing-dropdown"><a href="#"><span>Listing Dropdown</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                <ul>
              <li>
                <a href="/course/data-science-training-in-noida">Data Science in Noida</a>
              </li>
              <li>
                <a href="/course/data-science-training-in-delhi">Data Science in Delhi</a>
              </li>
              <li>
                <a href="/course/data-science-training-in-dehradun">Data Science in Dehradun</a>
              </li>
            ...
            <div class="rowclass ">
                ...
                <div class="banner-section">
                    ...
                    <div class="right-banner">
                        <h2 class="TExt-banner">Data Scientist in ${data.city}</h2>
  ...
  <div class="choose-container">
    <div class="heading">${data.chooseHeading}</div>
    <div class="content" id="content">
      <p>${data.chooseDescription}</p>
      ${data.chooseTopic.map((topic, index) => {
        return `
          <p><b>${index + 1}. ${topic.topicHeading}</b></p>
          <p>${topic.topicDescription}</p>
          <ul>
            ${topic.topicPoint.map((element) => {
              return `<li><b>${element.mainPoint}</b>: ${element.pointDescription}</li>`;
            }).join('')}
          </ul>
          <p>${topic.topicEnd}</p>
        `;
  ...
  module.exports = generateDataScience;